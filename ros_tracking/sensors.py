...
def CreateSensorModels(tracker):
    ...
    for sensor in sensor_names:
        ...
        tracker.declare_parameter('sensors.' + sensor + '.spatial_states', rclpy.Parameter.Type.INTEGER)
        tracker.declare_parameter('sensors.' + sensor + '.spatial_meas', rclpy.Parameter.Type.INTEGER)
        ...
        tracker.declare_parameter('sensors.' + sensor + '.dim_classes', rclpy.Parameter.Type.INTEGER)        
        tracker.declare_parameter('sensors.' + sensor + '.dim_detections', rclpy.Parameter.Type.INTEGER)
        tracker.declare_parameter('sensors.' + sensor + '.detection_classes', rclpy.Parameter.Type.STRING_ARRAY)
        tracker.declare_parameter('sensors.' + sensor + '.semantic_sensor_model', rclpy.Parameter.Type.DOUBLE_ARRAY)
        tracker.declare_parameter('sensors.' + sensor + '.p_missed_det_list', rclpy.Parameter.Type.DOUBLE_ARRAY)
